...
class UserInfo(User):
    ...
    depart = models.ForeignKey(to='Department', on_delete=models.CASCADE, default=1)
...
class Customer(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '客户表'
...
class Campuses(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '校区表'
...
class ConsultRecord(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '跟进记录表'
