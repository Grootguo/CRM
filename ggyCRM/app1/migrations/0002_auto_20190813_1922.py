# Generated by Django 2.1.1 on 2019-08-13 11:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.Campuses', verbose_name='校区')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('class_list', models.ManyToManyField(to='app1.ClassList', verbose_name='已报班级')),
            ],
        ),
        migrations.AddField(
            model_name='userinfo',
        ...
        migrations.AddField(
            model_name='customer',
            name='introduce_from',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.Customer', verbose_name='转介绍自学员'),
        ),
        migrations.AddField(
